 ...
 */
exports.OAuthValidator.prototype.isValid = function(fullUrl, userKey, userSecret, httpRequestMethod, extraParams, authString) {
    ...
    var preparedParams = this.oauth._prepareParameters(userKey, userSecret, httpRequestMethod, fullUrl, extraParams);
